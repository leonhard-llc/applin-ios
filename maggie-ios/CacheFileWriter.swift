...
func readCacheFile(dataDirPath: String, _ session: MaggieSession) async {
...
class CacheFileWriter {
    ...
    func writeCacheFile(_ session: MaggieSession) async throws {
    ...
    public func scheduleWrite(_ session: MaggieSession) {
